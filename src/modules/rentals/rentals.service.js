  ...
  async issueRental(rentalData, userData) {
    try {
      const result = await rentalRepository.issueRental({
        ...
        totalItems: rentalData.total_items,
        securityDeposit: rentalData.security_deposit,
        subtotalAmount: rentalData.subtotal_amount,
        taxAmount: rentalData.tax_amount,
        discountAmount: rentalData.discount_amount,
        totalAmount: rentalData.total_amount,
        paidAmount: rentalData.paid_amount,
